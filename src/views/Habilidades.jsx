        ...
        <div className={styles.habilidadesContainer}>
            ...
            <div className={styles.habilidadesCardContainer}>
                ...
                <h2 className={styles.varKeyword}>Frontend</h2>
                    <ul>
                        <li><RiHtml5Fill size={30} color="#E34F26"/>HTML5</li>
                        <li><RiCss3Fill size={30} color="#1572B6"/>CSS3</li>
                        <li><SiJavascript size={30} color="#F7DF1E"/>JavaScript</li>
                        <li><RiReactjsLine size={30} color="#61DAFB"/>React</li>
                        <li><SiVite size={30} color="#646CFF"/>Vite</li>
                    </ul>
                </div>
                <div className={styles.habilidadesContainer + " " + styles.habilidadesCard}>
                <h2 className={styles.varValue}>Backend</h2>
                    <ul>
                        <li><SiNodedotjs size={30} color="#339933"/>Node.js</li>
                        <li><SiExpress size={30} color="#61DAFB"/>Express</li>
                        <li><SiMysql size={30} color="#E34F26"/>MySQL</li>
                    </ul>
                </div>
                <div className={styles.habilidadesContainer + " " + styles.habilidadesCard}>
                <h2 className={styles.stringValue}>Herramientas</h2>
                    <ul>
                        <li><SiGit size={30} color="#F05033"/>Git</li>
                        <li><SiGithub size={30} color="#181717"/>GitHub</li>
                        <li><SiVercel size={30} color="#000000"/>Vercel</li>
                    </ul>
                </div>
            </div>
            <p>
